var contactNo=new Cleave("#contactNumber",{delimiters:["(",")","-"],blocks:[0,3,3,4]}),str_dt=function(e){var e=new Date(e),t=""+["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][e.getMonth()],a=""+e.getDate(),e=e.getFullYear();return t.length<2&&(t="0"+t),[(a=a.length<2?"0"+a:a)+" "+t,e].join(", ")};form=document.getElementById("deals-form"),form.addEventListener("submit",function(e){if(e.preventDefault(),form.checkValidity()){var t=document.getElementById("dealTitle").value,a=document.getElementById("dealValue").value,s=document.getElementById("deatType").value,l=document.getElementById("dealOwner").value,d=document.getElementById("dueDate").value,i=document.getElementById("contactNumber").value,n=document.getElementById("dealEmail").value,c=document.getElementById("contactDescription").value,o=l.split(" "),o=`<div class="card">
                            <div class="card-body">
