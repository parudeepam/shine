...
const paths = {
    ...
    dist: {
        base: {
            dir: './Velzon/wwwroot/assets',
            assets: './Velzon/wwwroot/assets'
        },
        libs: {
            dir: './Velzon/wwwroot/assets/libs'
        },
        css: {
            dir: './Velzon/wwwroot/assets/css',
        },
        js: {
            dir: './Velzon/wwwroot/assets/js',
            files: './Velzon/wwwroot/assets/js/pages',
        },
    },
    src: {
        base: {
